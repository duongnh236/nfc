...
public class NFCPassportModel {
    ...
    public private(set) lazy var userName : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let userName = dg13.userName else { return nil }
        return userName
    }()
    public private(set) lazy var motherName : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let motherName = dg13.motherName else { return nil }
        return motherName
    }()
    
    public private(set) lazy var fatherName : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let fatherName = dg13.fatherName else { return nil }
        return fatherName
    }()

     public private(set) lazy var homeTown : String? = {
            guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
                  let homeTown = dg13.homeTown else { return nil }
            return homeTown
        }()

    public private(set) lazy var wifeName : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let wifeName = dg13.wifeName else { return nil }
        return wifeName
    }()
    
    public private(set) lazy var endDay : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let endDay = dg13.endDay else { return nil }
        return endDay
    }()
    
    public private(set) lazy var birthDay : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let birthDay = dg13.birthDay else { return nil }
        return birthDay
    }()
    
    public private(set) lazy var startDay : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let startDay = dg13.startDay else { return nil }
        return startDay
    }()
    
    public private(set)  lazy var sodGroupIds : [String] = []
    
    public private(set) lazy var identityNumber : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let identityNumber = dg13.identityNumber else { return nil }
        return identityNumber
    }()
    
    public private(set) lazy var identifyingCharacteristics : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let identifyingCharacteristics = dg13.identifyingCharacteristics else { return nil }
        return identifyingCharacteristics
    }()
    
    public private(set) lazy var oldIdentityCard : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let oldIdentityCard = dg13.oldIdentityCard else { return nil }
        return oldIdentityCard
    }()
    
    public private(set) lazy var ethnic : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let ethnic = dg13.ethnic else { return nil }
        return ethnic
    }()
    
    public private(set) lazy var sex : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let sex = dg13.sex else { return nil }
        return sex
    }()
    public private(set) lazy var religion : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let religion = dg13.religion else { return nil }
        return religion
    }()
    
    public private(set) lazy var address : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let address = dg13.address else { return nil }
        return address
    }()
    ...
    public private(set) lazy var nationality : String? = {
            guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
                  let nationality = dg13.nationality else { return nil }
            return nationality
        }()
    ...
    public private(set) lazy var rawDataCOM : [UInt8] = {
        guard let _rawDataCOM = dataGroupsRead[.COM] as? COM else { return [] }
        return _rawDataCOM.rawData ?? [UInt8]()
    }()
    
    public private(set) lazy var rawDataSOD : [UInt8] = {
        guard let _rawDataSOD = dataGroupsRead[.SOD] as? SOD else { return [] }
        return _rawDataSOD.rawData ?? [UInt8]()
    }()
    
    public private(set) lazy var rawDataDG1 : [UInt8] = {
        guard let _rawDataDG1 = dataGroupsRead[.DG1] as? DataGroup1 else { return [] }
        return _rawDataDG1.rawData ?? [UInt8]()
    }()
    
    public private(set) lazy var rawDataDG14 : [UInt8] = {
        guard let _rawDataDG14 = dataGroupsRead[.DG14] as? DataGroup14 else { return [] }
        return _rawDataDG14.rawData ?? [UInt8]()
    }()
    
    public private(set) lazy var rawDataDG2 : [UInt8] = {
        guard let _rawDataDG2 = dataGroupsRead[.DG2] as? DataGroup2 else { return [] }
        return _rawDataDG2.rawData 
    }()
    
    public private(set) lazy var rawDataDG15 : [UInt8] = {
        guard let _rawDataDG15 = dataGroupsRead[.DG15] as? DataGroup15 else { return [] }
        return _rawDataDG15.rawData ?? [UInt8]()
    }()

    public private(set) lazy var rawDataDG13 : [UInt8] = {
            guard let _rawDataDG13 = dataGroupsRead[.DG13] as? DataGroup13 else { return [] }
            return _rawDataDG13.rawData ?? [UInt8]()
        }()
    
    public private(set) lazy var chipID : String? = {
        guard let dg13 = dataGroupsRead[.DG13] as? DataGroup13,
              let chipID = dg13.chipID else { return nil }
        return chipID
    }()
    /// personal number
    ...
    public func addDataGroup(_ id : DataGroupId, dataGroup: DataGroup ) {
        print("DataGroupID \(id) DataGroup \(dataGroup)")
    ...
    public func dumpPassportData( selectedDataGroups : [DataGroupId], includeActiveAuthenticationData : Bool = false) -> [String:String] {
        ...
        print("selectedDataGroups \(selectedDataGroups)")
...
//        }
    ...
    private func validateAndExtractSigningCertificates( masterListURL: URL ) throws {
        ...
        case .success(let csca):
            self.certificateSigningGroups[.issuerSigningCertificate] = csca as! X509Wrapper
    ...
    private func ensureReadDataNotBeenTamperedWith( useCMSVerification: Bool ) throws  {
        ...
        let (sodHashAlgorythm, sodHashes, sodGroupIds) = try parseSODSignatureContent( asn1Data )
        
        self.sodGroupIds = sodGroupIds
    ...
    private func parseSODSignatureContent( _ content : String ) throws -> (String, [DataGroupId : String], [String]){
        var currentDG = ""
        var sodHashAlgo = ""
        var sodHashes :  [DataGroupId : String] = [:]
        var sodGroupId : [String] = []
            ...
            if line.contains( "d=2" ) && line.contains( "OBJECT" ) {
                ...
                if let range = line.range(of: "[HEX DUMP]:") {
                    ...
                    if currentDG != "", let id = Int(currentDG, radix:16) {
                        print("currentDG IDdddddddddddd \(currentDG)")
                        print("dgList IDdddddddddddd \(id)")
                        sodGroupId.append("\(id)")
        ...
        print("        - Hashes.     - \(sodHashes)")
        return (sodHashAlgo, sodHashes, sodGroupId)
    }
}
